      MODULE bundle2
        ...
        !| |    DEALLOCATION:                : deallocate_b2(set)                           | |
        !| |    DELETE FROM BUNDLE           : delete_b2(set, eps)                            | |
        !| |    DELETE FROM BUNDLE           : delete_b2_ind(set, ind)                        | |
        !| |                                                                                  | |
        !| |                                                                                  | |
        ...
        !**************************************************************************************
           ...
           SUBROUTINE delete_b2_ind(set, ind)
               !
               ...
               up = set%b_size
                ...
                set%indeksi = up                          ! the place where the new bundle element tried to be added
                IF (set%b_size /= set%b_maxsize) THEN     ! we test whether the bundle is full or not
                    set%full = .FALSE.
                ELSE
                    set%full = .TRUE.
