      MODULE dbdc
        ...
        !*..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..*     
        !|                                                                                      |
        !|  Code utilizes the new version of PLQDF1 by Ladislav Luksan as a quadratic solver.   |
        !|                                                                                      |
        !|                                                                                      |
        !| .**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**. |
        !*..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..**..*
        ...
        !***************************************************************************************
           ...
           SUBROUTINE DBDC_algorithm( f_solution, f0, mit,&
            ...
            !**************************** NEEDED FROM USER ************************************* 
               ...
               INTEGER, DIMENSION(:), INTENT(IN) :: problem1                ! the f1 in problem
               INTEGER, DIMENSION(:), INTENT(IN) :: problem2                ! the f2 in problem
...
! ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ---- ----
        ...
        !***************************************************************************************        
            ...
            !**************************** NEEDED FROM THE USER *********************************  
               ...
               INTEGER, DIMENSION(:) :: problem1           ! the f1 of the problem
               INTEGER, DIMENSION(:) :: problem2           ! the f2 of the problem
...
!               t = t_max                   ! selects the upper bound
        ...
        !***************************************************************************************        
            ...
            !**************************** NEEDED FROM THE USER ********************************* 
               ...
               INTEGER, INTENT(IN):: user_n                   ! the dimension of the problem
               INTEGER, DIMENSION(:), INTENT(IN):: problem1   ! the f1 of the problem
               INTEGER, DIMENSION(:), INTENT(IN):: problem2   ! the f2 of the problem
